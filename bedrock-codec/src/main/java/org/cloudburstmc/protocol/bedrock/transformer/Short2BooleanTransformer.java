...
public final class Short2BooleanTransformer implements EntityDataTransformer<Short, Boolean> {
    ...
    @Override public Short serialize(BedrockCodecHelper helper, EntityDataMap map, Boolean value) { return (short) (value ? 1 : 0); }
    @Override public Boolean deserialize(BedrockCodecHelper helper, EntityDataMap map, Short value) { return value != 0; }
}
