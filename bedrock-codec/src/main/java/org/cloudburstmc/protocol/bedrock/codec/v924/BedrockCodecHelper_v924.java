...
public class BedrockCodecHelper_v924 extends BedrockCodecHelper_v898 {
    ...
    public GatheringsConfigurationJoinInfo readGatheringsConfiguration(ByteBuf buf, BedrockCodecHelper h) {
        return new GatheringsConfigurationJoinInfo(h.readUuid(buf), h.readString(buf), h.readUuid(buf), h.readString(buf),
                h.readString(buf), h.readUuid(buf), h.readString(buf), h.readString(buf));
    }
}
